        ...
        function mainmenu() {
            ...
            'openwave','mobilexplorer','operamini'];
                ...
                if(b=='nokia' || b=='iphone' || b=='blackberry' || b=='sony' || b=='lg' || b=='htc_tattoo' || b=='samsung' || b=='symbian' || b=='SymbianOS' || b=='elaine' || b=='palm' || b=='series60' || b=='windows ce' || b=='android' || b=='obigo' || b=='netfront' || b=='openwave' || b=='mobilexplorer' || b=='operamini'){
                    $("#whatsend").attr("href","https://api.whatsapp.com/send?l=es&phone=51958178609&text=%C2%A1Hola!%20bienvenido%20a%20TapimakcPerú,%20porfavor%20ind%C3%ADquenos%20su%20requerimimento.");
                    
                }else{
                    $("#whatsend").attr("href","https://web.whatsapp.com/send?l=es&phone=51958178609&text=%C2%A1Hola!%20bienvenido%20a%20TapimakcPerú,%20porfavor%20ind%C3%ADquenos%20su%20requerimimento.");
                }
                }
                mainmenu();
